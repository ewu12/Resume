...
\runsubsection{Whiting School of Engineering Manufacturing Department}
...
\runsubsection{Precision Care Medicine} \\
\descript{Predictive Approach to Acute Kidney Injury}
\location{August 2019 -- Present | Baltimore, MD}
\vspace{\topsep} % Hacky fix for awkward extra vertical space
\begin{tightemize}
...
\runsubsection{Real World Human Data} \\
\descript{Analysis and Visualization}
\location{January 2019 -- May 2019 | Baltimore, MD}
\begin{tightemize}
...
\runsubsection{Residential Life}
\descript{Residential Advisor}
...
\runsubsection{JHUnions}
\descript{Programming Board}
\location{December 2018 -- present | Baltimore, MD}
\begin{tightemize}
